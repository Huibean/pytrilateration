...
int initialize(double x0, double y0, double z0, double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3)
{
    ...
    anchorArray[0].y = y0; //anchor0.y uint:m
    anchorArray[0].z = z0; //anchor0.z uint:m

    anchorArray[1].x = x1; //anchor1.x uint:m
    anchorArray[1].y = y1; //anchor1.y uint:m
    anchorArray[1].z = z1; //anchor1.z uint:m

    anchorArray[2].x = x2; //anchor2.x uint:m
    anchorArray[2].y = y2; //anchor2.y uint:m
    anchorArray[2].z = z2; //anchor2.z uint:m
...
int getPos(int r1, int r2, int r3, int r4)
{
    ...
    Range_deca[0] = r1; //tag to A0 distance
    Range_deca[1] = r2; //tag to A1 distance
	Range_deca[2] = r3; //tag to A2 distance
	Range_deca[3] = r4; //tag to A3 distance
